...
describe("milestonesService", () => {
  ...
  const mockMilestones = [
    mockMilestone,
    { ...mockMilestone, id: "milestone-2", name: "Phase 2" },
  ];
  ...
  describe("update", () => {
    it("should update a milestone", async () => {
      ...
      const result = await milestonesService.update("milestone-1", {
        name: "Updated Milestone",
      });

      expect(api.patch).toHaveBeenCalledWith("/milestones/milestone-1", {
        name: "Updated Milestone",
      });
