...
describe('usersService', () => {
  ...
  const mockUsers = [mockUser, { ...mockUser, id: 'user-2', email: 'test2@example.com' }];
  ...
  describe('update', () => {
    it('should update a user', async () => {
      ...
      const result = await usersService.update('user-1', { firstName: 'Updated' });

      expect(api.patch).toHaveBeenCalledWith('/users/user-1', { firstName: 'Updated' });
