...
describe('projectsService', () => {
  ...
  describe('getAll', () => {
    ...
    it('should combine all parameters', async () => {
      ...
      expect(api.get).toHaveBeenCalledWith('/projects?page=2&limit=20&status=DRAFT');
    });
  });
  ...
  describe('update', () => {
    it('should update a project', async () => {
      ...
      const result = await projectsService.update('project-1', { name: 'Updated Project' });

      expect(api.patch).toHaveBeenCalledWith('/projects/project-1', { name: 'Updated Project' });
  ...
  describe('addMember', () => {
    it('should add a member to project', async () => {
      ...
      expect(api.post).toHaveBeenCalledWith('/projects/project-1/members', memberData);
    });
  });
