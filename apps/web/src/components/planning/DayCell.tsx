    ...
    return (
      ...
      >
        ...
        {cell.isHoliday && !leaveVisible && (
          ...
          >
            <span
              className={`${viewMode === "month" ? "text-lg" : "text-2xl"}`}
            >
              🎉
            </span>
        ...
        {isHalfDayLeave && (
          ...
          >
            <span
              className={`${viewMode === "month" ? "text-base" : "text-xl"}`}
            >
              {leaveIcon}
            </span>
            {viewMode === "week" && (
        ...
        {otherHalfLeave && (
          <div
            ...
            style={{
              ...
              borderStyle:
                otherHalfLeave.status === "PENDING" ? "dashed" : "solid",
            }}
            ...
            {viewMode === "week" && (
              <>
                <span
                  className="font-medium text-[11px] leading-tight"
                  style={{
                    color: otherHalfLeave.leaveType?.color ?? "#10B981",
                  }}
                >
                ...
                .map((assignment) => {
                  ...
                  return (
                    <div
                      key={assignment.id}
                      onClick={() =>
                        onPredefinedTaskClick(assignment, cell.date)
                      }
