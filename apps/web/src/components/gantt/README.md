...
const tasks: GanttTaskRow[] = [
  {
    id: 't1', name: 'Cahier des charges',
    startDate: new Date('2026-01-01'), endDate: new Date('2026-01-15'),
    progress: 100, status: TaskStatus.DONE,
    milestoneId: 'm1', milestoneName: 'Conception', isMilestone: false,
  },
  {
    id: 't2', name: 'Validation',
    startDate: new Date('2026-01-15'), endDate: new Date('2026-01-15'),
    progress: 0, status: TaskStatus.TODO,
    milestoneId: 'm1', milestoneName: 'Conception', isMilestone: true,
  },
];
