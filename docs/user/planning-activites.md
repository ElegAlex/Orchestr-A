...
- **Nom** : libellé affiché dans le planning (ex : _Permanence accueil matin_).
...
- **Type de récurrence** :
  ...
  - **Mensuelle — occurrence ordinale** : choisissez le rang et le jour (ex : _3e mardi_, _dernier jeudi_). Sélectionnez _Dernière_ pour la dernière occurrence du mois.
...
- Les agents **déjà assignés** apparaissent cochés et grisés (libellé _« déjà assigné »_).
- Les agents **en congé validé** sur ce jour apparaissent grisés avec le type de congé (_« en congé · CA »_).
...
_Guide version 1.2 — Support : DSI CPAM 92_
