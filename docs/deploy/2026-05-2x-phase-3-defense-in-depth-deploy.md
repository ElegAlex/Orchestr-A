...
**Mini-arc closures so far:** DAT-032 + DAT-033 (`7af1991`, migration `20260528120000`); DAT-036 (`ce026d6`, migration `20260528130000`); DAT-038 (`a99dda5`, migration `20260528140000`); COR-034 (`08d04b1`, code-only); COR-035 (`d5ac36a`, code-only).
**Remaining:** DAT-034, DAT-035, DAT-037 (BLOCKED-DESIGN-DECISION), COR-037.
